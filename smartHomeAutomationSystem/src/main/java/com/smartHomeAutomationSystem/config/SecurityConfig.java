...
import com.smartHomeAutomationSystem.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/rooms").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/api/users/me").authenticated()
                        .requestMatchers("/api/devices/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/api/rules/**").hasAnyRole("USER", "ADMIN")
